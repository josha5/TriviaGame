$(document).ready(function() {
    ...
    const results = [
        ...
        const getAnswers  = function() {
            var correctAnswer = results[incrementer].correct_answer;
            let incorrectAnswers = results[incrementer].incorrect_answers;
            incorrectAnswers.forEach(elem => {
                answersArr.push(elem);
            });
            answersArr.splice(Math.floor(Math.random() * 5), 0, correctAnswer); 
        } 
        
        getAnswers();
        $("#answer1").html(answersArr[0]);
        $("#answer2").html(answersArr[1]);
        $("#answer3").html(answersArr[2]);
        $("#answer4").html(answersArr[3]);
